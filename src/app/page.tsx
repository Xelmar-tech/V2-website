      ...
      <main className="bg-white flex flex-col items-center px-5">
        ...
        <div className="py-16 max-w-6xl w-full justify-between flex md:flex-row flex-col gap-12">
          <div className="max-w-lg flex flex-col gap-7">
                  ...
                  IsraelRex is top notch!
                  <br/>I trust his ability to rapidly comprehend and transform wireframes, mockups, and ideas into high-quality designs.
                  He consistently delivers professional designs that facilitate clear and straightforward implementation for developers.
                  Furthermore, his enthusiastic and cooperative attitude enhances the overall experience of working with him, making him an excellent designer.
                  </h3>
                  <div className="flex items-center gap-4">
                      <Image src="/image/icedcool.png" width={57} height={57} alt="icedcool"/>
                      <div className="flex flex-col text-black">
                          <p className="font-syne font-bold text-xl">Icedcool</p>
                          <p className="font=syne font-medium text-sm">Project Manager at BC</p>
                      </div>
                  </div>
          </div>
          <div className="max-w-lg flex flex-col gap-7">
            <h3 className="font-syne text-[#D4D4D4] text-3xl font-medium leading-[3.06rem]">
                  ...
                  ideas and improvements. He demonstrated a keen sense of aesthetics and a contemporary design
